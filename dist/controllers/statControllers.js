...
export const getDashBoardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const latestTransactionsPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthProducts, thisMonthUsers, thisMonthOrders, lastMonthProducts, lastMonthUsers, lastMonthOrders, productsCount, usersCounts, allOrders, lastSixMonthOrders, categories, femaleUsersCount, latestTransactions,] = await Promise.all([
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const [processingOrders, shippedOrders, deliveredOrders, categories, productsCount, productsOutOfStock, allOrders, allUsers, adminUsers,] = await Promise.all([
